...
fprintf(fid,'*HEADING\n');
fprintf(fid,'*NODE, NSET=ALLNODES, input=F8Node.txt\n');
fprintf(fid,'*ELEMENT, TYPE=C3D8, ELSET=ALL, input=F8EL.txt\n');
...
fprintf(fid,'*boundary\n');
fprintf(fid,'Load,1,1,190\n');
fprintf(fid,'Load,2,2,190\n');
fprintf(fid,'Load,3,3,190\n');
