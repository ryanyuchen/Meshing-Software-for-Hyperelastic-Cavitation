...
fprintf(fid,'*HEADING\n');
fprintf(fid,'*NODE, NSET=ALLNODES, input=F6Node.txt\n');
fprintf(fid,'*ELEMENT, TYPE=C3D8, ELSET=ALL, input=F6EL.txt\n');
...
fprintf(fid,'*boundary\n');
fprintf(fid,'Load,1,1,45\n');
fprintf(fid,'Load,2,2,45\n');
fprintf(fid,'Load,3,3,45\n');
